namespace NMG.Core.Reader
{
    ...
    public class IngresMetadataReader : IMetadataReader
    {
        ...
        {
            List<Column> primaryKeys = table.Columns.Where(x => x.IsPrimaryKey.Equals(true)).ToList();
        ...
        public List<ForeignKey> DetermineForeignKeyReferences(Table table)
        {

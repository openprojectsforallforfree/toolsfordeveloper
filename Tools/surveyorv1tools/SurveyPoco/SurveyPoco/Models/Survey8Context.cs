...
{
    public partial class Survey8Context : DbContext
    {
        static Survey8Context()
        {
            Database.SetInitializer<Survey8Context>(null);
        }

        public Survey8Context()
            : base("Name=Survey8Context")
        {
        }

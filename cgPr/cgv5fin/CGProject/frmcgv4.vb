...
#End Region
    ...
    Private Sub btnObject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnObject.Click
        ...
        If ds Is Nothing Then Return
        For Each dt As DataTable In ds.Tables
            textout = textout + vbCrLf + New clsPrivates().gencreate(dt)
            textout = textout + vbCrLf + New clsProperties().gencreate(dt)
            textout = textout + vbCrLf + New clsConstructor_DataRow().gencreate(dt)
            'textout = textout + vbCrLf + New clsConstructora().gencreate(dt)
            ' textout = textout + vbCrLf + New clsConstructorb().gencreate(dt)
            'textout = textout + vbCrLf + New clsEqualOperator().gencreate(dt) + "}"
    ...
    Private Sub BTNdB2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNdB2.Click
        ...
        If ds Is Nothing Then Return
        For Each dt As DataTable In ds.Tables
            textout = textout + vbCrLf + New clsDb2().gencreate(dt)
        Next
        Clipboard.SetText(textout)
    End Sub
End Class